...
0x00004040, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,|    # 0x00 - 0x03 |  Mario (Dr Mario), Donkey, Link, Samus
0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x07075555,|    # 0x04 - 0x07 |  SZerosuit, Yoshi, Kirby, Fox,
0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0B101818,|    # 0x08 - 0x0B |  Pikachu, Luigi, Captain, Ness (Icies, Olimar),
...
0xFFFFFFFF, 0x1D1D4444, 0xFFFFFFFF, 0xFFFFFFFF,|    # 0x1C - 0x1F |  Charizard, Squirtle (Greninja), Ivysaur, Dedede
0xFFFFFFFF, 0xFFFFFFFF, 0x22225353, 0xFFFFFFFF,|    # 0x20 - 0x23 |  Lucario, Ike, Robot (Car), Jigglypuff
...
0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x3F564141,|    # 0x3C - 0x3F |  ????, ????, ????, Roy
